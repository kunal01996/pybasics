...
# Randomly generating a list of elements


rand_list_1 = [random.randint(1, 100) for i in range(10)]
rand_list_2 = [random.randint(1, 100) for i in range(10)]
print(set(rand_list_1 + rand_list_2))
